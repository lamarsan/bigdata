package com.spark.streaming.project.spark

import com.spark.streaming.project.dao.{CourseClickCountDAO, CourseSearchClickCountDAO}
import com.spark.streaming.project.domain.{ClickLog, CourseClickCount, CourseSearchClickCount}
